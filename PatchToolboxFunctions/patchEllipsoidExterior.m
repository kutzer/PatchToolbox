function pOut = patchEllipsoidExterior(ptch,efit)
% PATCHELLIPSOIDEXTERIOR finds the portion of a patch that lies outside of 
% the surface of an ellipsoid.
%   pOut = PATCHELLIPSOIDEXTERIOR(ptch,efit) defines the input 
...
%                            faces that are outside of the ellipsoid
%
